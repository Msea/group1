...
3. To run the program, type "java DataParser" followed by the name of your input file, followed by the name of your output file. Then hit enter.

When Entering the file names, you may want to note the following:
A. The names of these files shoudl be seperated by a space.

B. Please include the file extenstion of the file in question(.txt, .csv).
